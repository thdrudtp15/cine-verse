        ...
        <div className="content-container py-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <Link
                    ...
                    className="relative overflow-hidden group bg-background-elevated border border-border rounded-lg p-8 shadow-lg shadow-black/20 hover:border-accent-secondary/50 transition-all duration-300 hover:shadow-xl hover:shadow-accent-secondary/10"
                >
                    <div className="flex items-start gap-4 mb-6">
